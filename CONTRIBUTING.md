...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/export-regex
   cd export-regex
   ```
...
```sh
https://github.com/flex-development/export-regex/compare/main...$branch
```
...
[17]: https://github.com/flex-development/export-regex/discussions/new?category=q-a
